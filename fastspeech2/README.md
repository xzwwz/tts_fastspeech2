...
```
python synthesize.py --text "大家好" --restore_step 400000 --mode single -p config/BZNSYP/preprocess.yaml -m config/BZNSYP/model.yaml -t config/BZNSYP/train.yaml
...
python synthesize.py --text "wo3 shi4 nan1 kai3 da4 xue3 de1" --restore_step 400000 --mode single -p config/BZNSYP/preprocess.yaml -m config/BZNSYP/model.yaml -t config/BZNSYP/train.yaml --duration_control 0.8 --energy_control 0.8
```
...
python prepare_align.py config/BZNSYP/preprocess.yaml
```
...
python3 preprocess.py config/BZNSYP/preprocess.yaml
```
...
python train.py -p config/BZNSYP/preprocess.yaml -m config/BZNSYP/model.yaml -t config/BZNSYP/train.yaml
```
